...
function getRandomImg() {
    ...
    req.open("GET", "https://dog.ceo/api/breeds/image/random"); // request "get me images", "from this URL"
...
//___________________________________________________________________________________________________________________________________
              ...
              function getBreedImg(e) {
                let breed = e.target.value; // sparar värdet av vad som trycks på
                let req = new XMLHttpRequest (); // sparar i en variabel
                req.open("GET", "https://dog.ceo/api/breed/"+breed+"/images/random"); // gör ett GET.anrop för att hämta data(bilder) från sidan
                req.addEventListener("load", parseBreedImg); // sätter en eventlyssnare på ('när datan(bilderna) är hämtade' --> 'starta funktionen parseImg()')
                req.send(); // skickar en HTTP-request från JavaScripten i webbläsaren.
              }
              //=================== parse breed images =======================================//
